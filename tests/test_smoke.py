...
PROVIDER_ENV_KEYS = (
    ...
    "MOONSHOT_LIVE_EVAL_ENABLED",
    "MOONSHOT_PRICE_STATUS",
    "MISTRAL_ENABLED",
    "MISTRAL_API_KEY",
    ...
    "MISTRAL_LIVE_EVAL_ENABLED",
    "MISTRAL_PRICE_STATUS",
    "AUTO_PROVIDER_ORDER",
    ...
    "MOONSHOT_TASK_CATEGORIES",
    "MISTRAL_TASK_CATEGORIES",
    "OPENAI_QUALITY_CLASS",
    "ANTHROPIC_QUALITY_CLASS",
    "GEMINI_QUALITY_CLASS",
    "XAI_QUALITY_CLASS",
    "DEEPSEEK_QUALITY_CLASS",
    "MOONSHOT_QUALITY_CLASS",
    "MISTRAL_QUALITY_CLASS",
    "OPENAI_COST_CLASS",
    ...
    "MOONSHOT_LATENCY_CLASS",
    "MISTRAL_LATENCY_CLASS",
    ...
    "MOONSHOT_SUPPORTS_VISION",
    "MISTRAL_SUPPORTS_VISION",
    ...
    "MOONSHOT_SUPPORTS_STRUCTURED_OUTPUT",
    "MISTRAL_SUPPORTS_STRUCTURED_OUTPUT",
    ...
    "MOONSHOT_INPUT_PRICE_PER_MILLION",
    "MOONSHOT_OUTPUT_PRICE_PER_MILLION",
    "MOONSHOT_PRICE_CURRENCY",
    "MISTRAL_INPUT_PRICE_PER_MILLION",
    "MISTRAL_OUTPUT_PRICE_PER_MILLION",
    "MISTRAL_PRICE_CURRENCY",
    "SEARCH_PROVIDER",
    "SEARCH_API_KEY",
