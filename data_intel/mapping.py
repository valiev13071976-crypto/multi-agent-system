...
_ALIAS: dict[str, str] = {
    ...
    "закупка": ROLE_PURCHASE_PRICE,
    "цена_закупки": ROLE_PURCHASE_PRICE,
    "закупочная_цена": ROLE_PURCHASE_PRICE,
    "cost": ROLE_PURCHASE_PRICE,
    "selling_price": ROLE_SELLING_PRICE,
    "розница": ROLE_SELLING_PRICE,
    "цена_продажи": ROLE_SELLING_PRICE,
    "продажная_цена": ROLE_SELLING_PRICE,
    "promo_price": ROLE_PROMO_PRICE,
    "акция": ROLE_PROMO_PRICE,
    "промо": ROLE_PROMO_PRICE,
    "currency": ROLE_CURRENCY,
    "валюта": ROLE_CURRENCY,
    "stock": ROLE_STOCK,
    "остаток": ROLE_STOCK,
    "наличие": ROLE_STOCK,
    "reserved_stock": ROLE_RESERVED_STOCK,
    "резерв": ROLE_RESERVED_STOCK,
    "available_stock": ROLE_AVAILABLE_STOCK,
    "доступно": ROLE_AVAILABLE_STOCK,
    "brand": ROLE_BRAND,
    "бренд": ROLE_BRAND,
    "category": ROLE_CATEGORY,
    "категория": ROLE_CATEGORY,
    "barcode": ROLE_EAN,
    "штрихкод": ROLE_EAN,
    "order_id": ROLE_ORDER_ID,
    "заказ": ROLE_ORDER_ID,
    "document_id": ROLE_DOCUMENT_ID,
    "debt": ROLE_DEBT,
    "долг": ROLE_DEBT,
    "amount": ROLE_AMOUNT,
    "сумма": ROLE_AMOUNT,
