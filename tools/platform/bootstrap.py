...
from tools.platform.descriptors import (
    ...
    content_create_descriptor,
    content_export_artifact_descriptor,
    ...
    data_compare_workbooks_descriptor,
    data_excel_assistant_descriptor,
...
def register_platform_tools(
    ...
    *,
    ...
    registrations = [
        ...
        (data_excel_assistant_descriptor(enabled=data_enabled), data),
        (data_compare_workbooks_descriptor(enabled=data_enabled), data),
        ...
        (content_create_descriptor(enabled=content_enabled), content),
        (content_export_artifact_descriptor(enabled=content_enabled), content),
